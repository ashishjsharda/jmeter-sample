...
//        if (jmeterHome.exists()) {
            File jmeterProperties = new File("src/test/resources/bin/jmeter.properties");
...
//                JMeter initialization (properties, log levels, locale, etc)
                ...
                SaveService.saveTree(testPlanTree, new FileOutputStream("target/example.jmx"));
                ...
                String logFile = "target/example.jtl";
